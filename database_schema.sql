...
CREATE OR REPLACE TRIGGER "on_platform_settings_update" BEFORE UPDATE ON "public"."platform_settings" FOR EACH ROW EXECUTE FUNCTION "public"."handle_platform_settings_update"();

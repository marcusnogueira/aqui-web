  ...
  public: {
    Tables: {
      ...
      business_subcategories: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_subcategories_business_type_id_fkey"
      ...
      customer_on_the_way: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_on_the_way_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "customer_on_the_way_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "customer_on_the_way_vendor_id_fkey"
      ...
      customer_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_reports_reporter_id_fkey"
            columns: ["reporter_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "customer_reports_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      moderation_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "moderation_logs_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      review_reports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "review_reports_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      search_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "search_logs_vendor_clicked_fkey"
            columns: ["vendor_clicked"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
          },
      ...
      vendor_announcements: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendor_announcements_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      vendor_live_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendor_live_sessions_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      vendor_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendor_reports_reporter_id_fkey"
            columns: ["reporter_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      vendor_specials: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendor_specials_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      vendor_static_locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_static_vendor"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vendor_static_locations_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "live_vendors_with_sessions"
            referencedColumns: ["id"]
      ...
      vendors: {
        Row: {
          ...
          status: Database["public"]["Enums"]["vendor_status_enum"] | null
        ...
        Relationships: [
          {
            foreignKeyName: "vendors_approved_by_fkey1"
            columns: ["approved_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Enums: {
      feedback_type_enum: "BUG" | "FEATURE" | "GENERAL"
